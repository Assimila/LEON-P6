...
LOG_CODE = "multitemporal_speckle_filter_atbd"
...
def apply_datacube(cube: xr.DataArray, context: Context) -> xr.DataArray:
    ...
    This is the formulation from the ATBD.
    It is an inverse local-mean weighted average.
    ...
    sum_inv_mu = inv_mu.rolling(t=window_size, center=True).sum()

    output = sum_ni / sum_inv_mu
