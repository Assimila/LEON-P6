...
from udf import multitemporal_speckle_filter_atbd


class Test_multitemporal_speckle_filter_atbd(unittest.TestCase):
    def setUp(self):
        self.radius = 2
        self.window_size = 5
        self.context = {
    ...
    def test_constant_unchanged(self):
        ...
        output_xr = multitemporal_speckle_filter_atbd.apply_datacube(
            input_xr, self.context
        )
    ...
    def test_temporal_outlier_smoothed(self):
        ...
        sum_inv_mu = 4 * (1 / 5.0) + 1 / mu
        expected = sum_ni / sum_inv_mu
    ...
    def test_extra_dims(self):
        ...
        for band in (0, 1):
            with self.subTest(band=band):
                ...
                expected = multitemporal_speckle_filter_atbd.apply_datacube(
    ...
    def test_radius_not_int(self):
        ...
        with self.assertRaises(ValueError):
            multitemporal_speckle_filter_atbd.apply_datacube(input_xr, context)
    ...
    def test_window_size_invalid(self):
        ...
        for window_size in (2, 4):
            with self.subTest(window_size=window_size):
                ...
                with self.assertRaises(ValueError):
                    multitemporal_speckle_filter_atbd.apply_datacube(
                        input_xr, context
                    )
    ...
    def test_insufficient_temporal_data(self):
        ...
        with self.assertRaises(ValueError):
            multitemporal_speckle_filter_atbd.apply_datacube(input_xr, self.context)
